...
if (!class_exists('request_a_quoteClass')) {
    class request_a_quoteClass{
        ...
        private function init(){
            ...
            //add_filter('map_meta_cap', array($this, 'wpse_6533_map_unrestricted_upload_filter'), 0, 2);
        }
        ...
        */
        ...
        function request_a_quote_admin_menu_function(){
            add_menu_page( 'Request a Quote', 'Request a Quote', 'manage_options', 'request-a-quote', array($this, 'submenufunction'), $this->plugin_url . 'asset/css/images/filter.png', 50 );
            add_submenu_page( 'request-a-quote', 'Settings', 'Settings', 'manage_options', 'request-a-quote-settings', array( $this, 'request_a_quote_settingsfunction' ) );
        }
        ...
        <div class="request_a_quote_cover">
            ...
            <div class="raq_open">
                ...
                <form id="raq_open_submit" method="post" action="" enctype="multipart/form-data">
                    ...
                    <?php 
                        $raq_open_input_checkbox_values = array('3D Laser Scanning', 'Drawing Creation', 'As-built or BIM Modeling', 'Reverse Engineering', 'Civil/Structural or Piping Design', 'Turn-key Design to lnstall', 'Equipment Upgrades', 'Augmented Reality', '3D Human Scanning', 'Spatial Programming');
                    ...
                    <select name="raq_open_input_project_status" class="raq_open-input-selector" id="raq_open_input_project_status">
                        <option class="raq_open_input_option_project_status" value="Ready to purchase services now">Ready to purchase services now</option>
                        <option class="raq_open_input_option_project_status" value="Project requires a minimum of 3 bids">Project requires a minimum of 3 bids</option>
                        <option class="raq_open_input_option_project_status" value="Looking for new service providers">Looking for new service providers</option>
                        <option class="raq_open_input_option_project_status" value="Preparing for projects in the future">Preparing for projects in the future</option>
                        <option class="raq_open_input_option_project_status" value="Research to perform your own services">Research to perform your own services</option>
                        <option class="raq_open_input_option_project_status" value="Researching competitor pricing">Researching competitor pricing</option>
                    </select>
                ...
                <div class="raq_open-terms-and-conditions"><a href="#" onClick="MyWindow=window.open('https://www.globaldesignsolutions.com/terms-conditions/','MyWindow','width=600,height=300'); return false;">Terms and conditions</a></div>
            </div>
            </div>
        </div>
        <?php
        ...
        function request_a_quote_sendajax(){
            ...
            foreach ($raq_open_input_checkbox as $key => $single_file){
                ...
                array_push( $service_for_user, $single_file );
                $keys++;
            }
            ...
            $challenge_submit_body_for_user_us = '<table class="es-wrapper" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; padding: 0; margin: 0; width: 100%; height: 100%; background-repeat: repeat; background-position: left top;" width="100%" cellspacing="0" cellpadding="0">
                <tbody>
                    <tr style="border-collapse: collapse;">
                        ...
                        <p style="margin: 5px 0px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size: 18px;">Upload File Url: ' . admin_url( 'admin.php?page=request-a-quote', 'https' ) . '</span></p>
                        </td>
                    </tr>
                </tbody>
            </table>';
            ...
            $file_ids = implode("|||",$attachments);
            $raq_open_services = implode("|||",$raq_open_input_checkbox);
            $table_name = $this->request_a_quote_tbl;
            $insert = $this->wpdb->insert( 
                $table_name, 
                array(
                    'names' => $raq_open_input_name,
                    'title' => $raq_open_input_title,
                    'project_status' => $raq_open_input_project_status,
                    'phone_number' => $raq_open_input_phone_number,
                    'email' => $raq_open_input_email,
                    'services' => $raq_open_services,
                    'budget' => $raq_open_input_budget,
                    'messages' => $raq_open_input_Message,
                    'file_ids' => $file_ids,
                ),
            ...
            $challenge_submit_user_body = '<table class="es-wrapper" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; padding: 0; margin: 0; width: 100%; height: 100%; background-repeat: repeat; background-position: left top;" width="100%" cellspacing="0" cellpadding="0">
                <tbody>
                    <tr style="border-collapse: collapse;">
                        <td style="padding: 0px; margin: 0px; height: 24px;" align="left">
                        <p style="margin: 5px 0px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size: 18px;">Hello ' . $raq_open_input_name . ',</span></p>
                        <p style="margin-bottom: 15px;"></p>
                        <p style="margin: 5px 0px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size: 18px;">Thank you for your Quote Request.</span></p>
                        <p style="margin-bottom: 15px;"></p>
                        <p style="margin: 5px 0px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size: 18px;">John will be your account representative, and will contact you within the next 24hrs.</span></p>
                        <p style="margin-bottom: 15px;"></p>
                        <p style="margin: 5px 0px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size: 18px;">If your inquiry is urgent, you may call GDS toll-free at 1-800-839-3342 or utilize the options below:</span></p>
                        <p style="margin-bottom: 15px;"></p>
                        <p style="margin: 5px 0px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size: 18px;">- Contact GDS directly online <a style="outline: none;" tabindex="-1" href="https://drift.me/gdsrepresentative" target="_blank" rel="noopener">here.</a></span></p>
                        <p style="margin: 5px 0px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size: 18px;">- Schedule a meeting <a style="outline: none;" tabindex="-1" href="https://calendly.com/globaldesignsolutions/gds-project-consultation?month=2022-04" target="_blank" rel="noopener">here.</a></span></p>
                        <p style="margin-bottom: 15px;"></p>
                        <p style="margin: 5px 0px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size: 18px;">On behalf of the Global Design Solutions Team we look forward to serving you,</span></p>
                        <p style="margin-bottom: 15px;"></p>
                        <p style="margin: 5px 0px; text-align: left; mso-line-height-alt: 24px;"><span style="font-size: 18px;">GDS Corporate</span></p>
                        </td>
                    </tr>
                </tbody>
            </table>';
            $service_for_user_values = implode(", ",$service_for_user);
            $admin_mail_user = $raq_receive_mail;
            $email_user = $raq_open_input_email;
            $subject_1_user = 'GDS Request a quote - ' . $service_for_user_values;
            $body_1_user = stripslashes( $challenge_submit_user_body );
            $headers_1_user = 'From: ' . $admin_mail_user . "\r\n" .
            'Reply-To: ' . $admin_mail_user . "\r\n";
            $headers_1_user .= 'MIME-Version: 1.0' . "\r\n";
            $headers_1_user .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
            $sent_1 = wp_mail($email_user, $subject_1_user, $body_1_user, $headers_1_user);
            echo json_encode(
                array(
                    'message' => 'success',
                )
